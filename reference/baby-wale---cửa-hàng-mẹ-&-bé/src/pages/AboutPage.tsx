...
export const AboutPage: React.FC = () => {
  ...
  return (
    <div id="baby-wale-about-page" className="max-w-5xl mx-auto px-4 sm:px-6 py-6 space-y-12">
      <Breadcrumbs items={[{ label: 'Về Baby Wale' }]} />

      {/* Hero Brand Introduction */}
      <div className="text-center space-y-4 max-w-2xl mx-auto">
        <BabyWaleLogo size="lg" className="justify-center mb-2" />
