...
export function LoginView() {
  ...
  return (
    <div className="mx-auto w-full max-w-md space-y-8 py-10 lg:py-16">
      <div className="text-center">
        <h1 className="text-2xl font-bold tracking-tight text-neutral-900">
          Đăng nhập
        </h1>
        <p className="mt-2 text-sm text-neutral-600">
          Đăng nhập vào tài khoản Baby Wale của bạn
        </p>
      </div>

      <div className="bg-white px-6 py-8 shadow-sm ring-1 ring-neutral-200 sm:rounded-xl sm:px-10">
